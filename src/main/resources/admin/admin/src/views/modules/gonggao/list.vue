        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '招聘公告标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.gonggaoName" placeholder="招聘公告标题" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '招聘公告类型' : ''">
                        <el-select v-model="searchForm.gonggaoTypes" placeholder="请选择招聘公告类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gxjyzhaopin/upload/gonggaoMuBan.xls"
                        >批量导入招聘公告数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gonggao','导入导出')"
