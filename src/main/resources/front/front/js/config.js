...
var centerMenu = [
    ...
    ,{
        name: '就业知识收藏',
        url: '../jiuyezhishiCollection/list.html'
    }
    ,{
        name: '职位收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/gxjyzhaopin/admin/dist/index.html#/login";
