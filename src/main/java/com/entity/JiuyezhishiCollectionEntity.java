...
public class JiuyezhishiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiuyezhishiCollectionEntity() {

	}

	public JiuyezhishiCollectionEntity(T t) {
		try {
