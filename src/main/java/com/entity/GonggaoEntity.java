...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 招聘公告标题
     */
    @ColumnInfo(comment="招聘公告标题",type="varchar(200)")
     ...
     * 招聘公告图片
     */
    @ColumnInfo(comment="招聘公告图片",type="varchar(200)")
     ...
     * 招聘公告类型
     */
    @ColumnInfo(comment="招聘公告类型",type="int(11)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="招聘公告发布时间",type="timestamp")
     ...
     * 招聘公告详情
     */
    @ColumnInfo(comment="招聘公告详情",type="text")
