...
public class JiuyezhishiLiuyanView extends JiuyezhishiLiuyanEntity implements Serializable {
	...
	public JiuyezhishiLiuyanView() {

	}

	public JiuyezhishiLiuyanView(JiuyezhishiLiuyanEntity jiuyezhishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jiuyezhishiLiuyanEntity);
